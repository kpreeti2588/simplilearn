...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.webservice.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:9090/emp-service/services/HelloWorld";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webservice.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.com", "HelloWorld"));
        }
